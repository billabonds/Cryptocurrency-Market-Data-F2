...
function pushGridContent()
{
    arr.forEach(element => {
        ...
        <div id="${element.id}" class="current-price">
        ₹  ${element.current_price}
        </div>
        
        <div style="padding: 10px;">
        <div style="margin-left: 2px; font-size:13px; color:#f3f3f3b9; padding:0 1em;">Total Volume: ${element.total_volume.toLocaleString()}</div>
        <div style="margin-left: 2px; font-size:13px; color:#f3f3f3b9; padding:0 1em;">Market Cap: ${element.market_cap.toLocaleString()}</div>
        </div>
        </div>`
